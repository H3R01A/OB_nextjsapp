...
export default function TickerPage(props: PageProps) {
  ...
  return (
    <main>
      <div className="mt-20 flex flex-col items-center text-white">
        <Card className="w-[50rem] h-[28rem] bg-black text-white">
          <CardHeader className="flex flex-row mt-4">
            <div className='mr-3'>{tokenFavorited && <Heart />}</div>
          ...
          <CardFooter className="flex flex-col items-center space-y-4">
            <Button onClick={handleAddTokenToDB}>Add to token favorite</Button>
            <Button onClick={handleDeleteTokenFrmDB}>
